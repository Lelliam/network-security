    ...
    export default {
        ...
        methods: {
            InitRadar() {
                ...
                let width = document.getElementById('radar').clientWidth;
                let height = document.getElementById('radar').clientHeight;
                document.getElementById('radar').style.width = width+'px';
                document.getElementById('radar').style.height = height+'px';

                let testChart = this.$echarts.init(document.getElementById('radar'));
